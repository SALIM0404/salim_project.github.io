...
function seed(){
  ...
  const c = (code,name,deptId,lectId,sessions,Nostudent) => { const id = nextId('course'); db.courses.push({id,code,name,departmentId:deptId,lecturerId:lectId,sessionsPerWeek:sessions,No_of_students:Nostudent}); return id; };
